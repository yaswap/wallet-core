...
import { YaswapError, UnknownError } from '../../YaswapErrors';
import { UNISWAP_V2_ERROR_SOURCE_NAME, UNISWAP_V2_ERRORS } from '.';
import { ErrorParser } from '../ErrorParser';
import { ValidationError } from '../../YaswapErrors/ValidationError';
export class UniswapV2SwapErroParser extends ErrorParser<Error, UniswapV2SwapErrorParserDataType> {
  ...
  protected _parseError(error: Error, data?: UniswapV2SwapErrorParserDataType): YaswapError {
