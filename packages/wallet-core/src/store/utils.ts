...
import { EvmChainProvider, EvmWalletProvider } from '@yaswap/evm';
import { AssetTypes, ChainId, getChain } from '@yaswap/cryptoassets';
...
/*
  Sort chains
  Always display first 4 coins: YAC, BTC, LTC, DOGE, ETH. Other coins will be displayed based on following conditions:
