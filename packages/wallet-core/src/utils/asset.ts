...
export const verifyIPFSHash = (ipfsHash: string) => {
  ...
  */
  console.log('TACA ===> [wallet-core] verifyIPFSHash, ipfsHash = ', ipfsHash)
  let errorString = ''
  let rawIPFSHash = ''
  ...
  if (ipfsHash.startsWith('Qm') && ipfsHash.length === 46) {
    try {
      ...
      * Total 34 bytes
      */
      console.log('TACA ===> [wallet-core] verifyIPFSHash, cidv0 = ', cid, ', cid.multihash = ', cid.multihash)
  ...
  // CIDv1
    ...
    try {
      ...
      */
      ...
      console.log('TACA ===> [wallet-core] verifyIPFSHash, cidv1 = ', cid, ', cid.multihash = ', cid.multihash)
...
export const isAvailableTokenName = async (tokenName: string, network: Network) => {
  ...
  if (data && data.length > 0) {
    console.log('TACA ===> [wallet-core], isAvailableTokenName, data = ', data, ', return false')
    return false
  }
  console.log('TACA ===> [wallet-core], isAvailableTokenName, data = ', data, ', return true')
  return true
};
